<template>
  <div>
    ...
    <div>
      ...
      <ul>
        <li>
          <strong>방문자 수 감소</strong>: 전월 대비 4.45% 감소, CtC -424bps
        </li>
        <li>
          <strong>판매 단가 하락</strong>: 2.7% 하락, CtC -259bps
        </li>
        <li>
          <strong>CVR(전환율) 하락</strong>: 92bps 감소, CtC -152bps
        </li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <em>
            ⇒ 단가 상승에도 불구, 방문자 수 및 CVR 하락으로 전체 매출 감소
          </em>
        </li>
      </ul>
    </div>
